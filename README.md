...
* Copy or rename the module directory to certificate.
* Replace all occurances of certificate in files with the new name for your question type.
* Rename files that have certificate replacing certificate with the new name for your question type.
* Replace '@copyright  2014 Crystal Barton (cbarto11@uncc.edu)' with something like @copyright  2013 Jamie Pratt (me@jamiep.org)
